...
/// </summary>
public class TestDelayProcessor : AudioProcessor<TestDelayModel>
{
    ...
    public TestDelayProcessor() : base(AudioSampleSizeSupport.Float32)
    {
        _bufferLeft = Array.Empty<float>();
        _bufferRight = Array.Empty<float>();
    }

    public override Guid ControllerClassId => TestDelayController.ClassId;
